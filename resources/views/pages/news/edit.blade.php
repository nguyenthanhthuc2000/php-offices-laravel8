...
@section('content')
    ...
    <form action="{{ route('news.update', $news->id) }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
        @csrf
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <input type="title" class="form-control" value="{{ $news->title }}" name="title" id="title" placeholder="Tiêu đề bài viết..." required>
                            @error('title')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="ckeditor" name="contents" rows="3" required>
                                {{ $news->content }}
                            </textarea>
                            @error('contents')
                            <span class="error text-danger" >{{ $message }}</span>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="review-img">
                            <img id="review-img" src="{{asset('upload/'.$news->image)}}" style=" width: 100%; border: 3px dashed blue;">
                        </div>
                    </div>
                </div>
